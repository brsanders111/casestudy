...
public final class SqlQueries {
	...
	public static final String GET_POLICIES = "SELECT * from Policys p, Locations l where p.QUOTE_ID= l.QUOTE_ID and l.USERNAME = ?";
	...
	public static final String CANCEL_POLICY = "UPDATE Policys SET POLICY_STATUS = 'CANCELLED', POLICY_END_DATE=TO_DATE(?, 'yyyy-mm-dd') where POLICY_KEY = ?";
	// PRIVATE //
